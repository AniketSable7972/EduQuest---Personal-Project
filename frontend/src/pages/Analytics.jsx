...
export default function Analytics() {
  ...
  useEffect(() => {
    Promise.all([analyticsApi.getHistory(), analyticsApi.getStats()])
      ...
      {stats && (
        <div className="grid-2" style={{ marginBottom: "2rem" }}>
          <div className="card" style={{ textAlign: "center" }}>
            <h3 style={{ color: "var(--text-muted)", fontSize: "0.875rem" }}>
              Contests Played
            </h3>
            <p
              style={{
          ...
          <div className="card" style={{ textAlign: "center" }}>
            ...
            <p style={{ fontSize: "2.5rem", fontWeight: 800 }}>
              {formatTime(stats.averageCompletionTimeMs)}
            </p>
          </div>
        </div>
      )}
